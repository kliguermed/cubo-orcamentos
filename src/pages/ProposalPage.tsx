  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section 
        ...
        style={{
          backgroundImage: pageLayouts?.cover_background 
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              ...
              <div className="text-sm text-left space-y-2">
                {(pageLayouts?.payment_methods || settings?.payment_terms || 
                  "Pagamento à vista com desconto de 5%. Parcelamento em até 12x no cartão.")
                  .split('.').map((line, index) => line.trim() && (
